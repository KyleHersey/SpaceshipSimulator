...
public abstract class Ship {
     ...
     * @param m the model
     */
    public abstract void shoot(Model m);
     ...
     * @param m the model
     */
    public abstract void onDeath(Model m);
    ...
    public void setStartPoint(Ship s, Model m) {
        ...
        if (team == 1) {
            ...
            startX = m.width - 20 - rand.nextInt(20);
        }
        int startY = rand.nextInt(m.height);
        s.coords = new Coordinates(startX, startY);


        //s.coords = new Model.Coordinates(rand.nextInt(m.drawingFrame.getWidth()), rand.nextInt(m.drawingFrame.getHeight()));
    }
